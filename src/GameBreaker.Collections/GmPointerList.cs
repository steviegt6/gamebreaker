...
using GameBreaker.Collections.Abstractions;

// ReSharper disable MethodOverloadWithOptionalParameter

namespace GameBreaker.Collections;
    ...
    where T : IGmSerializable, new()
{
    ...
    public virtual void Deserialize(
        ...
        elementReader ??= UsePointerMap
            ? (d, n) => d.ReadPointerObject<T>(d.Reader.ReadInt32(), n)
            : (d, n) => d.ReadPointerObjectUnique<T>(d.Reader.ReadInt32(), n);
